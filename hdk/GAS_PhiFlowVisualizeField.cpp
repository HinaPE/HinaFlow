...
const SIM_DopDescription* GAS_PhiFlowVisualizeField::getDopDescription()
{
...
bool GAS_PhiFlowVisualizeField::solveGasSubclass(SIM_Engine& engine, SIM_Object* obj, SIM_Time time, SIM_Time timestep)
{
